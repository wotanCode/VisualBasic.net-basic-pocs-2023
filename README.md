# Practice projects in VisualBasic.net

Practice projects developed in Visual Basic .NET. Each project is independent from the others and is not related, with its own documentation.
